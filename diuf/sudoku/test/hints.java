 ...
 * this entry point by 1to9only @ http://forum.enjoysudoku.com/post280335.html#p280335
 */
...
public class hints {
    ...
    static String RELEASE = "2019-08-10";
    static String VERSION = "1.2.1.4";
    /**
     * Solve input puzzles and print results according to the output format.
     * @param args 729-char pemcilmarks
     */
